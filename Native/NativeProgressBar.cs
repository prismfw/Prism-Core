...
{
    /// <summary>
    /// Defines a progress bar that is native to a particular platform.
    /// These objects are meant to be paired with platform-agnostic <see cref="ProgressBar"/> objects.
    /// </summary>
    public interface INativeProgressBar : INativeElement
    {
        /// <summary>
