...
{
    /// <summary>
    /// Defines a rendered quadrangle that is native to a particular platform.
    /// These objects are meant to be paired with platform-agnostic <see cref="Quadrangle"/> objects.
    /// </summary>
    public interface INativeQuadrangle : INativeShape
    {
        /// <summary>
