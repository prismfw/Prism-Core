...
namespace Prism.UI.Controls
{
    ...
    public class Border : Element
    {
            ...
            : base(resolveType, resolveName, resolveParameters)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.TypeMustResolveToType, resolveType.FullName, typeof(INativeBorder).FullName), nameof(resolveType));
            }
