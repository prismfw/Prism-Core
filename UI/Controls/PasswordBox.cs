...
namespace Prism.UI.Controls
{
    ...
    public class PasswordBox : Control
    {
        ...
        public InputType InputType
        {
            ...
            set
            {
                if (value != InputType.Alphanumeric && value != InputType.Number)
                {
                    throw new ArgumentOutOfRangeException(nameof(InputType), string.Format(CultureInfo.CurrentCulture, Strings.OnlyTwoInputTypesSupported, InputType.Alphanumeric, InputType.Number, GetType().FullName));
                }
