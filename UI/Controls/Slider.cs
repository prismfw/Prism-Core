...
namespace Prism.UI.Controls
{
    ...
    public class Slider : Control
    {
            ...
            : base(resolveType, resolveName, resolveParameters)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Resources.Strings.TypeMustResolveToType, resolveType.FullName, typeof(INativeSlider).FullName), nameof(resolveType));
            }
