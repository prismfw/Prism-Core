...
namespace Prism.UI
{
    ...
    public class Popup : Visual
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Popup"/> class and pairs it with the specified native object.
        /// </summary>
        ...
        protected Popup(INativePopup nativeObject)
            : base(nativeObject)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Popup"/> class and pairs it with a native object that is resolved from the IoC container.
        /// </summary>
        /// <param name="resolveParameters">Any parameters to pass along to the constructor of the native type.</param>
        /// <exception cref="TypeResolutionException">Thrown when the native object does not resolve to an <see cref="INativePopup"/> instance.</exception>
        protected Popup(ResolveParameter[] resolveParameters)
            : base(resolveParameters)
        {
            ...
            if (nativeObject == null)
            {
                throw new TypeResolutionException(string.Format(CultureInfo.CurrentCulture, Strings.TypeMustResolveToType,
                    ObjectRetriever.GetNativeObject(this).GetType().FullName, typeof(INativePopup).FullName));
            }
