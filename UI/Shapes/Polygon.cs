...
namespace Prism.UI.Shapes
{
    ...
    public class Polygon : Shape
    {
        ...
        /// </summary>
        public Polygon()
            : this(typeof(INativePolygon), null)
        {
        }
        ...
        /// <exception cref="ArgumentException">Thrown when <paramref name="resolveType"/> does not resolve to an <see cref="INativePolygon"/> instance.</exception>
        ...
        protected Polygon(Type resolveType, string resolveName, params ResolveParameter[] resolveParameters)
            : base(resolveType, resolveName, resolveParameters)
        {
            nativeObject = ObjectRetriever.GetNativeObject(this) as INativePolygon;
            if (nativeObject == null)
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, Strings.TypeMustResolveToType, resolveType.FullName, typeof(INativePolygon).FullName), nameof(resolveType));
            }
