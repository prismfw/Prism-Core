...
namespace Prism.UI.Shapes
{
    ...
    /// </summary>
    [Resolve(typeof(INativePolyline))]
    public class Polyline : Shape
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Polyline"/> class and pairs it with the specified native object.
        /// </summary>
        ...
        protected Polyline(INativePolyline nativeObject)
            : base(nativeObject)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Polyline"/> class and pairs it with a native object that is resolved from the IoC container.
        ...
        /// <exception cref="TypeResolutionException">Thrown when the native object does not resolve to an <see cref="INativePolyline"/> instance.</exception>
        protected Polyline(ResolveParameter[] resolveParameters)
            : base(resolveParameters)
        {
            ...
            if (nativeObject == null)
            {
                throw new TypeResolutionException(string.Format(CultureInfo.CurrentCulture, Strings.TypeMustResolveToType,
                    ObjectRetriever.GetNativeObject(this).GetType().FullName, typeof(INativePolyline).FullName));
            }
