...
namespace Prism.UI.Shapes
{
    ...
    public abstract class Shape : Element
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Shape"/> class and pairs it with the specified native object.
        /// </summary>
        ...
        protected Shape(INativeShape nativeObject)
            : base(nativeObject)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Shape"/> class and pairs it with a native object that is resolved from the IoC container.
        ...
        /// <exception cref="TypeResolutionException">Thrown when the native object does not resolve to an <see cref="INativeShape"/> instance.</exception>
        protected Shape(ResolveParameter[] resolveParameters)
            : base(resolveParameters)
        {
            ...
            if (nativeObject == null)
            {
                throw new TypeResolutionException(string.Format(CultureInfo.CurrentCulture, Strings.TypeMustResolveToType,
                    ObjectRetriever.GetNativeObject(this).GetType().FullName, typeof(INativeShape).FullName));
            }
